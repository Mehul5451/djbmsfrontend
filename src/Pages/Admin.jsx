...
const AdminPanel = () => {
  ...
  const fetchDJs = async () => {
    try {
      const response = await axios.get("https://userbackend-bdc2.onrender.com/dj");
  ...
  const handleAddDJ = async () => {
    try {
      const response = await axios.post("https://userbackend-bdc2.onrender.com/dj", newDJ);
  ...
  const handleDeleteDJ = async (id) => {
    try {
      await axios.delete(`https://userbackend-bdc2.onrender.com/dj/${id}`);
  ...
  const fetchBookings = async () => {
    try {
      ...
      const response = await axios.get("https://userbackend-bdc2.onrender.com/bookings", {
  ...
  const handleBookingAction = async (id, status) => {
    try {
      const token = localStorage.getItem("adminToken");
      await axios.put(`https://userbackend-bdc2.onrender.com/bookings/${id}`,
        { status },
        { headers: { Authorization: `Bearer ${token}` },
      }
      );
  ...
  const handleDeleteBooking = async (id) => {
    try {
      const token = localStorage.getItem("adminToken");
      await axios.delete(`https://userbackend-bdc2.onrender.com/bookings/${id}`, {
        headers: { Authorization: `Bearer ${token}` },
 },
      );
  ...
  const handleLogout = async () => {
    try {
      await axios.post("https://userbackend-bdc2.onrender.com/admin-logout", {}, { withCredentials: true });
  ...
  const fetchEvents = async () => {
    try {
      const response = await axios.get("https://userbackend-bdc2.onrender.com/events");
  ...
  const handleAddEvent = async () => {
    ...
    try {
      const response = await axios.post("https://userbackend-bdc2.onrender.com/events", eventPayload, {
        headers: {
  ...
  const handleDeleteEvent = async (eventId) => {
    ...
    try {
      const response = await axios.delete(
        `https://userbackend-bdc2.onrender.com/events/${eventId}`,
        {
          headers: {
  ...
  useEffect(() => {
    const fetchTicketBookings = async () => {
      try {
        ...
        const response = await axios.get("https://userbackend-bdc2.onrender.com/ticket-bookings", {
          headers: {
  ...
  const handleTicketAction = async (id, status) => {
    try {
      ...
      const response = await axios.put(
        `https://userbackend-bdc2.onrender.com/ticket-bookings/${id}`,
  ...
  const handleDeleteTicketBooking = async (id) => {
    try {
      ...
      await axios.delete(`https://userbackend-bdc2.onrender.com/ticket-bookings/${id}`, {
        headers: {
