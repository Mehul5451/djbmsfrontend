...
const UserSide = () => {
  ...
  const handleViewDJs = async () => {
    ...
    try {
      const response = await axios.get("https://userbackend-bdc2.onrender.com/user-bookings", {
  ...
  const handleViewTickets = async () => {
    ...
    try {
      ...
      const response = await axios.get("https://userbackend-bdc2.onrender.com/user-ticket-bookings", {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const handleCancelBooking = async (bookingId) => {
    ...
    try {
      await axios.delete(`https://userbackend-bdc2.onrender.com/bookings/${bookingId}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const handleDeleteTicket = async (ticketId) => {
    ...
    try {
      await axios.delete(`https://userbackend-bdc2.onrender.com/book-tickets/${ticketId}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  return (
    <div style={{ padding: "20px", textAlign: "center" }}>
      ...
      <Card style={{ maxWidth: "900px", margin: "auto", padding: "20px" }}>
        <CardContent>
